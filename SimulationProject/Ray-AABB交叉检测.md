...
# slab的碰撞检测算法  
&emsp;&emsp;本文接下来主要讨论射线与AABB的关系，主要对box2d碰撞检测使用的slab的碰撞检测算法(==Slabs method==)进行介绍，然后使用python语言实现slab碰撞检测方法，该方法可以用于3D物体拾取等应用场景。  
...
<div align=center><img src="http://p05tunu6e.bkt.clouddn.com/18-1-22/14739430.jpg" width = "400" height = "300" alt="图片名称" align=center/></div>
<img src="http://p05tunu6e.bkt.clouddn.com/18-1-22/97654879.jpg" width = "350" height = "500" alt="图片名称" align=center/></div>
